defmodule SnmpKit.SnmpLib.MIB.DocsisMibTest do
  ...
  describe "Critical DOCSIS MIBs" do
        ...
        case result do
          ...
          {:warning, mib, warnings} ->
            ...
            assert length(warnings) > 0,
                   "#{name} should have warnings if returning warning result"
    ...
    test "DOCS-CABLE-DEVICE-MIB contains expected DOCSIS constructs" do
      ...
      assert has_definition_type(mib, :object_identifier),
             "Should have OBJECT IDENTIFIER definitions"
    end
    ...
    test "DOCS-IF-MIB contains expected interface constructs" do
      ...
      assert "DocsisVersion" in textual_convention_names,
             "Should have DocsisVersion textual convention"
