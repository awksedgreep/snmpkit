    ...
    [
      ...
      groups_for_modules: [
        ...
        "Manager": [
          ...
          SnmpKit.SnmpMgr.PerformanceBenchmark
        ],
        "SNMP Protocol": [
        ...
        "MIB Support": [
          ...
          SnmpKit.SnmpLib.MIB.AST,
          SnmpKit.SnmpLib.MIB.Preprocessor,
          SnmpKit.SnmpLib.MIB.SnmpTokenizer,
          SnmpKit.SnmpLib.MIB.Utilities,
          SnmpKit.SnmpLib.MIB.Error,
          SnmpKit.SnmpLib.MIB.Logger,
          SnmpKit.SnmpMgr.MIB
        ],
        "Device Simulation": [
          ...
          SnmpKit.SnmpSim.BehaviorConfig,
          SnmpKit.SnmpSim.BulkOperations,
          ...
          SnmpKit.SnmpSim.Device.ErrorInjector,
          SnmpKit.SnmpSim.ErrorInjector,
          SnmpKit.SnmpSim.LazyDevicePool,
          SnmpKit.SnmpSim.MultiDeviceStartup,
          SnmpKit.SnmpSim.PDUHelper,
          SnmpKit.SnmpSim.TestScenarios,
          SnmpKit.SnmpSim.TimePatterns,
          SnmpKit.SnmpSim.MIB.SharedProfiles,
          SnmpKit.SnmpSim.MIB.Compiler,
          SnmpKit.SnmpSim.MIB.BehaviorAnalyzer,
          SnmpKit.SnmpSim.TestHelpers,
          SnmpKit.SnmpSim.TestHelpers.PortAllocator,
          SnmpKit.SnmpSim.TestHelpers.PortHelper,
          SnmpKit.SnmpSim.TestHelpers.PerformanceHelper,
          SnmpKit.SnmpSim.TestHelpers.ProductionTestHelper,
          SnmpKit.SnmpSim.TestHelpers.StabilityTestHelper,
          SnmpKit.SnmpSim.Performance.OptimizedDevicePool,
          SnmpKit.SnmpSim.Performance.OptimizedUdpServer,
          SnmpKit.SnmpSim.Performance.PerformanceMonitor,
          SnmpKit.SnmpSim.Performance.ResourceManager,
          SnmpKit.SnmpSim.Performance.Benchmarks
        ]
      ]
    ]
  end
